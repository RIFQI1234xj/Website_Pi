    ...
    try {
      ...
      if (res.status === 'success' && res.data) {
        ...
        const mappedData = res.data.map((item: any) => ({
          ...
          fatherNik: item.father_nik,
          fatherOccupation: item.father_occupation,
          fatherEducation: item.father_education,
          fatherIncome: item.father_income,
          motherName: item.mother_name,
          motherNik: item.mother_nik,
          motherOccupation: item.mother_occupation,
          motherEducation: item.mother_education,
          motherIncome: item.mother_income,
